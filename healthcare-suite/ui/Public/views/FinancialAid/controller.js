...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'healthcare-suite.Public.FinancialAid.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('healthcare-suite.Public.FinancialAid.refresh', callback);
		},
		onFinancialAidStatusesModified: function(callback) {
			on('healthcare-suite.Public.FinancialAidStatuses.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/healthcare-suite/api/Public/FinancialAid.js';
	var statusOptionsApi = '../../../../../../../../services/v4/js/healthcare-suite/api/Public/FinancialAidStatuses.js';
	...
	$messageHub.onFinancialAidStatusesModified(statusOptionsLoad);
