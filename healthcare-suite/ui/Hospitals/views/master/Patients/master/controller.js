...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'healthcare-suite.Hospitals.Patients.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('healthcare-suite.Hospitals.Patients.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/healthcare-suite/api/Hospitals/Patients.js';
