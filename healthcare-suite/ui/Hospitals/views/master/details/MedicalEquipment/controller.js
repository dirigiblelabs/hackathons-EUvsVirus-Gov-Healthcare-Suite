...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'healthcare-suite.Hospitals.MedicalEquipment.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('healthcare-suite.Hospitals.MedicalEquipment.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/healthcare-suite/api/Hospitals/MedicalEquipment.js';
