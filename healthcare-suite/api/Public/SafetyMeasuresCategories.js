...
var dao = require("healthcare-suite/data/dao/Public/SafetyMeasuresCategories");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("SafetyMeasuresCategories not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/SafetyMeasuresCategories.js/" + entity.Id);
