...
var dao = require("healthcare-suite/data/dao/Public/VolunteerConfirmationStatuses");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("VolunteerConfirmationStatuses not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/VolunteerConfirmationStatuses.js/" + entity.Id);
