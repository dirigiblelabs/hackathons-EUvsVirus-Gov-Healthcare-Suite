...
var dao = require("healthcare-suite/data/dao/Public/SafetyMeasures");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("SafetyMeasures not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/SafetyMeasures.js/" + entity.Id);
