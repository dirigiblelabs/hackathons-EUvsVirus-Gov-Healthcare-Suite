...
var dao = require("healthcare-suite/data/dao/Hospitals/HospitalPersonnel");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("HospitalPersonnel not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/HospitalPersonnel.js/" + entity.Id);
