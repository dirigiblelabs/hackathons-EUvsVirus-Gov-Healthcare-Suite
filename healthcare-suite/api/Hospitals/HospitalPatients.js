...
var dao = require("healthcare-suite/data/dao/Hospitals/HospitalPatients");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("HospitalPatients not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/HospitalPatients.js/" + entity.Id);
