...
var dao = require("healthcare-suite/data/dao/Hospitals/ConditionHistory");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("ConditionHistory not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/ConditionHistory.js/" + entity.Id);
