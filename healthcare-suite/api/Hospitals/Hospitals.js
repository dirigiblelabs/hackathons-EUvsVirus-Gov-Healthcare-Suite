...
var dao = require("healthcare-suite/data/dao/Hospitals/Hospitals");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("Hospitals not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/Hospitals.js/" + entity.Id);
