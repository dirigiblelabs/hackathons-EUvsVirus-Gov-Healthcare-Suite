...
var dao = require("healthcare-suite/data/dao/Hospitals/ConditionTypes");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("ConditionTypes not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/healthcare-suite/api/ConditionTypes.js/" + entity.Id);
